...
export function WhatsAppConfig() {
  ...
  async function handleSave() {
    ...
    if (!config && (!accessToken.trim() || !tokenEdited)) {
      toast.error('O Permanent Access Token é obrigatório para a configuração inicial');
      return;
    }
    ...
    try {
      ...
      if (tokenEdited && accessToken !== MASKED_TOKEN && accessToken.trim()) {
        ...
        toast.error('Digite novamente o Permanent Access Token para salvar as alterações');
        setSaving(false);
        return;
      }
          ...
          >
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <div className="flex items-center gap-2">
                ...
                >
                  {isRegistered
                    ? 'Registrado — a Meta vai entregar eventos ao Rio Postes'
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  . Informe (ou corrija) o PIN de verificação em duas
                  etapas abaixo e clique em Salvar configuração para
                  tentar novamente.
                </>
              ) : (
                <>
                  Este número foi salvo antes de o rastreamento de
                  registro existir, ou o registro foi ignorado. Informe o
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-muted-foreground">
Uma string personalizada criada por você. Deve coincidir com o token que você definiu nas configurações de webhook da Meta.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Necessário apenas para configurar mensagens de <strong className="text-muted-foreground">entrada</strong>
                ...
                e cole-o aqui para que o Rio Postes possa inscrever o número —
                caso contrário, a Meta encaminha os eventos de entrada
                para o último app que reivindicou o número (o sintoma que
                afeta números secundários sob uma WABA compartilhada).{' '}
                Os <strong className="text-muted-foreground">números de teste da Meta</strong> não têm
                PIN e já vêm pré-registrados — deixe este campo em branco
                para eles. Deixá-lo em branco também mantém um registro
                existente intocado.
              </p>
            </div>
          </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Use esta URL como seu callback de webhook no Meta App Dashboard.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Selecione &quot;Business&quot; como o tipo de app</li>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Cole a <strong className="text-foreground">Webhook Callback URL</strong> exibida acima</li>
