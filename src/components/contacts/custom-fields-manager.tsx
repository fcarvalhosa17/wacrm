      ...
      <DialogContent className="border-border bg-popover text-popover-foreground sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            ...
            aparecem em todos os contatos e na ação de automação “Update Contact
            Field”.
          </DialogDescription>
        </DialogHeader>
        <CustomFieldsPanel />
...
export function CustomFieldsPanel() {
  ...
  async function handleDelete(field: CustomField) {
    if (
      !window.confirm(
        `Excluir "${field.field_name}"? Isso também remove o valor armazenado em todos os contatos. Isso não pode ser desfeito.`
      )
    ) {
      return;
    }
