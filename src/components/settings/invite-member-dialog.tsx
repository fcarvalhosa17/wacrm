...
export function InviteMemberDialog({
  ...
  async function handleCreate() {
    ...
    try {
      ...
      setResult({
        ...
        accountName: account?.name ?? 'nossa conta no Rio Postes',
      });
      onCreated();
    } catch (err) {
  ...
  function whatsappShareUrl(url: string): string {
    ...
    const accountName = result?.accountName ?? 'nossa conta no Rio Postes';
    const message = `Entre em ${accountName} no Rio Postes usando este link (válido por ${result?.expiresInDays} dias): ${url}`;
          ...
          <>
            ...
            <div className="space-y-3 py-2">
              ...
              <div className="rounded-md border border-amber-500/50 bg-amber-500/15 px-3 py-2 text-xs text-amber-200">
                ...
                Nunca armazenamos o texto original — assim que você fechar
                esta janela, a URL desaparece. Para compartilhar novamente,
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                Slack ou qualquer canal que preferir — sem necessidade de
                serviço de e-mail.
              </DialogDescription>
            </DialogHeader>
