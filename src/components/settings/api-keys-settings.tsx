        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-10 text-center">
            ...
            {canEditSettings ? (
              ...
              <p className="text-muted-foreground mt-1 text-xs">
                Peça para um administrador criar uma.
              </p>
            )}
          </CardContent>
        </Card>
        ...
        {createdKey ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Esta é a única vez em que a chave completa é exibida. Guarde-a
                em um lugar seguro — se você perdê-la, revogue-a e crie uma nova.
              </DialogDescription>
            </DialogHeader>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Dê o nome da integração que vai usá-la e conceda apenas os
                escopos necessários.
              </DialogDescription>
            </DialogHeader>
